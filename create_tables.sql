...
( phone_number    VARCHAR2(20)  NOT NULL,
  ...
  CONSTRAINT customer_phone_fk_customers FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);
...
( account_number    		    NUMBER(12)    NOT NULL,
  ...
  CONSTRAINT accounts_fk_customers FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);
...
CREATE TABLE credit_cards
 (
 	...
 	CONSTRAINT credit_cards_pk PRIMARY KEY(credit_card_number),
  	CONSTRAINT credit_cards_fk_customers FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);
...
CREATE TABLE loans
 (
 	...
 	CONSTRAINT loans_pk PRIMARY KEY(loan_number),
  	CONSTRAINT loans_fk_customers FOREIGN KEY(customer_id) REFERENCES customers(customer_id)
);
